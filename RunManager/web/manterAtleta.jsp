        ...
        <form action="ManterAtletaController?acao=confirmar${operacao}" method="post" name="frmManterAtleta">
            <table>
                <tr>
                    ...
                    <tr>
                        <td>Nome: </td> 
                        <td><input type="text" name="txtNome" value="${atleta.nome}" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="txtTelCel" value="${atleta.telCel}" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>></td>
                    </tr>
                    <tr>
                        <td>Telefone Residencial: </td> 
                        <td><input type="text" name="txtTelRes" value="${atleta.telRes}" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>></td>
                    </tr>
                    <tr>
                        <td>Cep: </td> 
                        <td><input type="text" name="txtCep" value="${atleta.cep}" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>></td>
                    </tr>
                    <tr>
                        <td>Rua: </td> 
                        <td><input type="text" name="txtRua" value="${atleta.rua}" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>></td>
                    </tr>
                    <tr>
                        <td>UF: </td> 
                        <td><input type="text" name="txtUf" value="${atleta.uf}" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>></td>
                    </tr>
                    <tr>
                        <td>Cidade: </td> 
                        <td><input type="text" name="txtCidade" value="${atleta.cidade}" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>></td>
                </tr>
