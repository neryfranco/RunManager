    ...
    <body id="principal">
        ...
        <form action="ManterOrganizadorController?acao=confirmar${operacao}" method="post" name="frmManterOrganizador" onsubmit="return validarFormulario(this)">
            <table>
                <tr>
                    <td>CPF: </td> 
                    <td><input type="text" name="txtCpf" value="${organizador.cpf}" <c:if test="${operacao != 'Incluir'}"> readonly</c:if>></td>
                    </tr>
                    <tr>
                        <td>Email: </td> 
                    ...
                    <tr>
                        <td>Cpf: </td> 
                        <td><input id="caixatexto" type="text" name="txtCpf" value="${organizador.apelido}" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>></td>
                    </tr>
                    <tr>
                        <td>Nome: </td> 
